...
@CucumberOptions(features="src\\test\\resources\\Feature files\\wgLoginPagge.feature", glue="org.stepdefinitions",
...
public class RunnerClassWGLoginPage extends JVMreport {
	@AfterClass
